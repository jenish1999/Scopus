...
const error = {
	previous: 'You have no borrowers added in the system',
	link: '/borrower/add-borrower',
	linkMessage: 'Click here to Add Borrower',
};

const AddBorrowerGroup = () => {
	const [borrowerGroupCount, setBorrowerGroupCount] = useState([]);
	return (
		<div style={{ display: 'flex', flexDirection: 'column' }}>
			...
			{borrowerGroupCount.length > 0 ? (
				<div className='form-borrower'>
					<div className='box box-info' style={{ display: 'flex', flexDirection: 'column' }}>
						...
						<div className='form-group' style={{ textAlign: 'center' }}>
							<Link>Click to add Custom Fields on this page</Link>
						</div>
