...
import { view_e_signatures } from '../../assets/tables';
...
const AdvancedSearch = () => {
	const options = [
		{ value: 'all staff', label: 'Sent By All Staff' },
				...
				<div className='box'>
					<div className='box-success'>
						...
						<div className='row'>
							<div className='col-md-6'>
								<div className='form-group'>
									<Select options={options} defaultValue={{ value: 'all staff', label: 'Sent By All Staff' }} />
								</div>
							</div>
