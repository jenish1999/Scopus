...
import { view_invesstor_acco } from '../../assets/tables';

const ViewInvestorsAcco = () => {
				...
				<div className='row'>
					<div className='col-lg-12 col-md-12 col-sm-12'>
						<div className='content-header'>
							<h1>View All Investor Accounts</h1>
						</div>
					</div>
				</div>
				<div className='row'>
									...
									<table className='table table-hover'>
										<thead>
											<tr className='table-info'>
												{view_invesstor_acco.map(t_head => (
													<th scope='col'>
														{t_head.value}
														{t_head.sort ? (
															<span>
...
export default ViewInvestorsAcco;
